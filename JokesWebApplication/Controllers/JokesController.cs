...
namespace JokesWebApplication.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,jokeQuestion,JokeAnsver")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,jokeQuestion,JokeAnsver")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
